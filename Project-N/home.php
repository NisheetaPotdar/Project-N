...
<header>
    ...
    <div class="swiper" style= "width: 98%";>
        ...
        <div class="swiper-wrapper"  >
            <?php if (!empty($imagePaths)): ?>
                <?php foreach ($imagePaths as $imagePath): ?>
                    ...
                    $base_url = "http://localhost/Project-N/image/";
                            ...
                            if(isset($_SESSION['username']))
                               {
                                    ...
                                    $query = mysqli_query($con, "SELECT data_user.* FROM `data_user` WHERE data_user.username = '$username'");
